...
class gtea(imdb):
    ...
    def _get_gtea_results_file_template(self):
    ...
    def _write_gtea_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == 'none':
                continue
            print('Writing {} GTEA results file'.format(cls))
            filename = self._get_gtea_results_file_template().format(cls)
    ...
    def _do_python_eval(self, output_dir='output'):
        annopath = self._output_dir + '\\GTEA' + '\\Annotations\\' + '{:s}.xml'
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_gtea_results_file(all_boxes)
