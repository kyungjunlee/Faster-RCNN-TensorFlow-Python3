...
class tego(imdb):
    def __init__(self, image_set):
        ...
        if image_set == "train":
          ...
          self._list_file = osp.join(self._data_path, "train_TEgO_voc_wholeBB.txt")
        elif image_set == "val-wholeBB":
          self._list_file = osp.join(self._data_path, "val_TEgO_voc_wholeBB.txt")
        elif image_set == "test-wholeBB":
          self._list_file = osp.join(self._data_path, "test_TEgO_voc_wholeBB.txt")
        elif image_set == "train-blind":
          self._list_file = osp.join(self._data_path, "train_TEgO_blind_voc.txt")
        elif image_set == "train-sighted":
          self._list_file = osp.join(self._data_path, "train_TEgO_sighted_voc.txt")
        elif image_set == "train-blind-wholeBB":
          self._list_file = osp.join(self._data_path, "train_TEgO_blind_voc_wholeBB.txt")
        elif image_set == "train-sighted-wholeBB":
          self._list_file = osp.join(self._data_path, "train_TEgO_sighted_voc_wholeBB.txt")
        else:
    ...
    def _get_tego_results_file_template(self):
    ...
    def _write_tego_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == 'none':
                continue
            print('Writing {} TEgO results file'.format(cls))
            filename = self._get_tego_results_file_template().format(cls)
    ...
    def _do_python_eval(self, output_dir='output'):
        annopath = self._output_dir + '\\TEgO' + '\\Annotations\\' + '{:s}.xml'
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_tego_results_file(all_boxes)
